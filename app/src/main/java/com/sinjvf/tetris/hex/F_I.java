...
public class F_I extends MyFiguresHex {
    F_I(){
        ...
        hs.add(new Point(1, 0)); hs.add(new Point(0, 0));hs.add(new Point(-1, -1));hs.add(new Point(-2, -1));
        ...
        hs=new HashSet<Point>();
        hs.add(new Point(-1, -1)); hs.add(new Point(0, 0));hs.add(new Point(1, -1));hs.add(new Point(2, 0));
